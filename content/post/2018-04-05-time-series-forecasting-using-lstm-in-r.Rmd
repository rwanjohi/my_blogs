...
The sigmoid function/layer outputs numbers between 0 and 1 with 0 meaning 'None goes through' and 1 means 'All pass' and therefore LSTM have the ability to, conditionally, add or delete information from the cell state.
...
2. Input gate:
      ...
      then the sigmoid layer creates an update as follows:
