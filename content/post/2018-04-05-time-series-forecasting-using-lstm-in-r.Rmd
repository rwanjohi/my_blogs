...
1. Forget gate:
      + This determine what information will be deleted from the cell state. It takes into account the hidden state from previous time step $ h_{t-1} $ and current input $ x_{t} $. The output is a number between 0 and 1 with 0 meaning 'delete all' and 1 implying 'remember all'
