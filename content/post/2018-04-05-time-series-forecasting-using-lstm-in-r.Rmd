...
3. Output gate:
       +  This regulates what info will be 
       The sigmoid layer filters the cell state that is going to output. 
       The cell state $ C_{t} $ is passed thro tanh function to scale values to -1, 1
