...
The information in the cells is cointained in cell state $ C_{t} $ and hidden state $ h_{t} $ and it is manipulated by mechanisms, known as gates, through *sigmoid* and *tanh* activation functions.

The sigmoid function/layer outputs number between 0 and 1 with 0 meaning 'None' and 1 means 'All'
