...
We transform the data to stationarity by differencing. By doing this we are dealing with difference between different time steps rather than the raw data themselves. 
```{r}
