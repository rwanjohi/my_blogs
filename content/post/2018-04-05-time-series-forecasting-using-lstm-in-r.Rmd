...
The gates takes in, as input, the hidden states from previous time step $ h_{t_1} $ and the current input $ x_{t} $ and multiply them pointwise by weight matrices, $ W $, and bias $ b $ is added to the product.
