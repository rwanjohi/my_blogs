...
## Define the model
LSTM expects the input batch shape to be a 3-dimensional array of [batch_size, timesteps, data_dim ]
...
Since the network is stateful, we have to provide the input batch in 3-dimensional arrary of [batch_size, timesteps, features] from the current [samples, f]
